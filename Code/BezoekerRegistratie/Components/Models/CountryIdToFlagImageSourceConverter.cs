...
namespace Components.Models
{
    ...
    public sealed class CountryIdToFlagImageSourceConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            try
            {
                var rel = Directory.GetCurrentDirectory();
                var path = $"/BezoekerApp;component/Images/{countryId.ToLower()}.png";
            ...
            {
                throw new FileNotFoundException("Kan de Images map niet vinden.");
            }
        }
